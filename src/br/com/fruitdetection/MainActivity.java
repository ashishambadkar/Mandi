...
public class MainActivity extends Activity implements CvCameraViewListener2 {
	...
	public Mat onCameraFrame(CvCameraViewFrame inputFrame) {
        ...
        for (int i = 0; i < fruitsArray.length; i++){
        	//Core.rectangle
        	Imgproc.rectangle(mRgba, fruitsArray[i].tl(), fruitsArray[i].br(), FRUIT_RECT_COLOR, 3);
        	Imgproc.putText(mRgba, "banana"+i, new Point(fruitsArray[i].x, fruitsArray[i].y), 3, 1, new Scalar(255, 0, 0, 255), 1);       	
        	//Core.re
        }
        return mRgba;
